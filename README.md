# Hi, I'm Yogesh Saini 👋
Java Developer • Spring Boot • RESTful APIs • Backend Engineering

- 💼 Open to: Full-time backend roles, internships, freelance backend tasks, and open-source contributions.
...
- Web: RESTful APIs, Servlet, JSP, Thymeleaf, HTML/CSS
...
- Implemented deep linking, async data handling, and managed session/registry data.

Java Developer Intern — Codules Technology Pvt. Ltd (Greater Noida)  
...
- Blog RESTful API (Backend)  
  Java-based REST API for creating, reading, updating, and deleting blog posts. Built with Spring Boot, Hibernate and MySQL; includes an AI-assisted blog creation feature.
